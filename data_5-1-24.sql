...
DROP USER if exists 'ajp'@'%' ;

-- Now create user with prop privileges
CREATE USER 'ajp'@'%' IDENTIFIED BY 'ajp';

GRANT ALL PRIVILEGES ON * . * TO 'ajp'@'%';


-- drop database
DROP SCHEMA IF EXISTS `hoc_ba_dien_tu_ajp`;

-- create database
CREATE SCHEMA `hoc_ba_dien_tu_ajp`;

use hoc_ba_dien_tu_ajp;
